...
class VisualizerVC: UIViewController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        bannerView.adUnitID = "ca-app-pub-2734087962752348/1275605118"
        ...
        if (GlobalConstants.isFree == true){
        PressureMac.frame.size.height = screenHeight - PressureMac.frame.origin.y - 50 //- bannerView.frame.height
        bottommargin = 50 //- bannerView.frame.height
            freeSpacing = bannerView.frame.height
        }
        else {
